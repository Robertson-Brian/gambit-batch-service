...
INSERT INTO BATCH (batch_id, resource_id, training_name, trainer_id, cotrainer_id, skill_type, training_type, start_date, end_date, location, good_grade_threshold, address_id, borderline_grade_threshold, week)
VALUES (NEXTVAL('BATCH_ID_SEQ'), 1, '1802JavaNick', 1, 2, 6, 'Java', PARSEDATETIME('2017-10-02','yyyy-mm-dd'), PARSEDATETIME('2017-12-06', 'yyyy-mm-dd'), 'Reston', 80, 1, 50, 2);
