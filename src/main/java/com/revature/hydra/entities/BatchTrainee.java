...
@Table(name = "BATCH_TRAINEE")
@Entity
@IdClass(BatchTrainee.class)
public class BatchTrainee implements Serializable {
	...
	public BatchTrainee(int traineeId, Integer batch_id) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BatchTrainee other = (BatchTrainee) obj;
		if (batchId == null) {
